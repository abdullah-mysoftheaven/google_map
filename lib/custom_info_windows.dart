...
class CustomInfoWindowsFlutter extends StatefulWidget{

  const CustomInfoWindowsFlutter({super.key});

  @override
  State<CustomInfoWindowsFlutter> createState() => _CustomInfoWindowsFlutterState();


}

class _CustomInfoWindowsFlutterState extends State<CustomInfoWindowsFlutter> {
